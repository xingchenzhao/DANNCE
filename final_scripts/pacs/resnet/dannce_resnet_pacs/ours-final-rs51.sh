...
python3 -m src.main \
    ...
    --save_dir=pacs/dannce-resnet/art-rs$((random_seed)) \
    --gpu=0 \
...
python3 -m src.main \
    ...
    --matsuura_augmentation \
    --adversarial_examples \
    --save_dir=pacs/dannce-resnet/sketch-rs$((random_seed)) \
    --gpu=0 \
    --random_seed=$random_seed \
...
python3 -m src.main \
    ...
    --matsuura_augmentation \
    --adversarial_examples \
    --save_dir=pacs/dannce-resnet/cartoon-rs$((random_seed)) \
    --gpu=0 \
    --random_seed=$random_seed \
    --adversarial_examples_lr=1e-3 \
    --adversarial_train_steps=5 \
...
python3 -m src.main \
    ...
    --matsuura_augmentation \
    --adversarial_examples \
    --save_dir=pacs/dannce-resnet/photo-rs$((random_seed)) \
    --gpu=0 \
    --random_seed=$random_seed \
